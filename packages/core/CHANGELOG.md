...
- d628de4: **Breaking:** the `Sandbox` class is renamed to `SandboxHandle`. Part of the naming inversion
...
- e343eab: Internal restructure: split `packages/core/src/sandbox.ts` (869 lines, one
