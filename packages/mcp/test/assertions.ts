 ...
 * accepts the identical pattern cleanly, and it lints fine as-is in packages/cli/test/). This
 * sidesteps it with a plain try/catch instead of touching shared lint config.
 */
