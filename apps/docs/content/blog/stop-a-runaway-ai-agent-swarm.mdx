...
- **Spawn budgets.** `spawnDepth` limits how many levels of children an agent may create, and
  ...
  outcome `budget-exceeded` and a `budget.denied` event.
...
resumes normally. See [Crash recovery](/docs/alineod/guides/crash-recovery).
...
- Guide: [Steering and pausing](/docs/alineod/guides/steering-and-pausing), and
  [Coordination](/docs/alineod/guides/coordination) for waiting on groups of agents.
- Example:
