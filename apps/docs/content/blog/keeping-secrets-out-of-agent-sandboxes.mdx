...
- **[Permission gate](/docs/agent/concepts/permissions)** — pause a tool call for a
  human before it runs, by mode (`"ask"`, `"readonly"`) or a per-tool policy.
- **[Egress approval hold](/docs/agent/concepts/permissions#holding-network-egress-for-approval)** —
