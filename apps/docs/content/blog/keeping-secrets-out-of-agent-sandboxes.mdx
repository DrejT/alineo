...
- **[Network policy](/docs/guide/control/egress)** — an allow/deny list of hosts the
...
- **[Permission gate](/docs/guide/control/permissions)** — pause a tool call for a
  human before it runs, by mode (`"ask"`, `"readonly"`) or a per-tool policy.
- **[Egress approval hold](/docs/guide/control/permissions#holding-network-egress-for-approval)** —
...
- [Credentials](/docs/guide/control/credentials) — the full reference.
