...
tag: Docs
cover: /blog-assets/docs-built-for-agents/cover.png
coverAlt: A documentation page emitting a Markdown twin, under the alineo wordmark.
---
...
```
https://docs.alineo.tech/docs/guide/quickstart        (HTML)
...
See [AI Resources](/docs/reference/ai-resources) for the full list.
