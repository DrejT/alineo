...
For an agent that should hold a specific host behind a **human decision** before it's reachable, see [Permission gate](/docs/agent/concepts/permissions#holding-network-egress-for-approval).
