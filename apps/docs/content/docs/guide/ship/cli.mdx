...
- [Commands reference](/docs/reference/cli) — all flags for each command
- [Registry format](/docs/reference/registry-format) — publish your own agent spec
- [Running an agent spec](/docs/guide/agents/spec) — full details on `Alineo.load()`
