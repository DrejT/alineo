...
For each one, alineod calls [`Alineo.reattach()`](/docs/reference/agent-sdk#alineoreattach), which binds to
...
If the bridge doesn't answer, alineod falls back to [`Alineo.resume()`](/docs/reference/agent-sdk#alineoresume),
