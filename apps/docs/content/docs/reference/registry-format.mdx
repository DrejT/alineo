...
This only saves the spec locally — it doesn't run anything. See [Running an agent spec](/docs/guide/agents/spec) for how to actually load and run it with `Alineo.load()`.
