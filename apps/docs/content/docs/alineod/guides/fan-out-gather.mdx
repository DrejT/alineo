...

{
  ...
  "spec": { "name": "worker-auth", "harness": "pi", "...": "..." },
...
A plain `waitFor` list waits for **every** dependency to finish. To start on the first one, on a quorum, or after
a deadline, see [Coordination](/docs/alineod/guides/coordination#waitfor-modes).
