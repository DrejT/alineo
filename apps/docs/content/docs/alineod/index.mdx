...
in-process through the [Agent SDK](/docs/agent/api-reference/alineo) and keeps a durable, append-only record of the whole swarm.
...
- **Drive it from any MCP client** — `npx alineo-mcp` exposes these controls as tools for Claude Code, Claude Desktop, and Cursor. See [MCP server](/docs/alineod/getting-started/mcp).
