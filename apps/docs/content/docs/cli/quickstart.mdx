...
- [Commands reference](/docs/cli/commands) — all flags for each command
- [Registry format](/docs/cli/registry) — publish your own agent spec
- [Running an agent spec](/docs/agent/concepts/spec) — full details on `Alineo.load()`
