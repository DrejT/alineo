...
- You want to start, prompt, or orchestrate agent sessions directly from the shell or from inside a Pi session (see the [Pi extension](/docs/alineo/0.3/commands#pi-extension)), without writing a TypeScript entry point.
...
<Cards>
  <Card
    href="/docs/alineo/0.3/getting-started/quickstart"
    title="Quickstart"
