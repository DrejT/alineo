...
<Cards>
  <Card
    href="/docs/alineo/0.1/registry/schema"
...
This only saves the spec locally — it doesn't run anything. See [Running an agent spec](/docs/alineo/0.1/using-sandboxes) for how to actually load and run it with `Agent.load()`.
