...
This only saves the spec locally — it doesn't run anything. See [Running an agent spec](/docs/alineo/v0.1/using-sandboxes) for how to actually load and run it with `Alineo.load()`.
