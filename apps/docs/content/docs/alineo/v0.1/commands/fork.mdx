...
- See the [Pi extension](/docs/alineo/v0.1/commands#pi-extension) section on the commands index for how a Pi session gets `alineo fork` syntax injected into its own guidance automatically.
