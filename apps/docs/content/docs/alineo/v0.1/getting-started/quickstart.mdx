...
- [Commands reference](/docs/alineo/0.1/commands) — all flags for each command
- [Registry format](/docs/alineo/0.1/registry) — publish your own agent spec
- [Running an agent spec](/docs/alineo/0.1/using-sandboxes) — full details on `Agent.load()`
