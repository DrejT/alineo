...
| ------------ | ------------------------------------------------------------------ |
| `sandbox-id` | The sandbox ID printed by `alineo start`/`alineo spawn`. Required. |
