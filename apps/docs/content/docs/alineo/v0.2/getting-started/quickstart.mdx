...
- [Commands reference](/docs/alineo/0.2/commands) — all flags for each command
- [Registry format](/docs/alineo/0.2/registry) — publish your own agent spec
- [Running an agent spec](/docs/alineo/0.2/using-sandboxes) — full details on `Alineo.load()`
