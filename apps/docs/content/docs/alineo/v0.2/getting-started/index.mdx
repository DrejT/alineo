...
- You want to start, prompt, or orchestrate agent sessions directly from the shell or from inside a Pi session (see the [Pi extension](/docs/alineo/0.2/commands#pi-extension)), without writing a TypeScript entry point.
...
<Cards>
  <Card
    href="/docs/alineo/0.2/getting-started/quickstart"
    title="Quickstart"
    description="Install alineo, start OpenSandbox, and fetch your first agent spec."
  />
  <Card
    href="/docs/alineo/0.2/commands"
    title="Commands"
